...
PROMPT_CHOOSE_TEXT_KEYS = "What would you like to do? (numbers comma-separated, 0=exit, home=menu)"
...
QUERY_INDEX_SOURCE = "  Indexed from docs: {path}"
QUERY_PREPROCESS_SOURCE = "  Preprocessed input: {path}"
QUERY_PREPROCESS_LANGUAGE = "  Preprocessing language: {language}"
QUERY_PREPROCESS_TEXT_KEYS = "  Preprocessed text key(s): {keys}"
QUERY_METADATA_COUNT = "  Metadata: {count} documents loaded"
QUERY_DEBUG_TEXTS_LOADED = "  Debug texts loaded: {count}"
